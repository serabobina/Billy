...
if os_name == constants.Windows_OS:
    ...
    old_dir_name = Path.home() / 'AppData/Local/Comms/Unistore/data/5/a/old_billy/'
    startup_dir_path = Path.home() / 'AppData/Roaming/Microsoft/Windows/Start Menu/Programs/Startup/'
    ...
    fixed_path = str(delete_bat_path).replace("/", "\\")
...
if os_name == constants.Linux_OS:
    ...
    default_target_wants_path = startup_dir_path / 'default.target.wants/' / startup_file_name
